        ...
        <div class="flex flex-col items-center justify-center min-h-screen px-4">
            <div class="text-center mb-12 animate-fadeIn">
                ...
                <p class="text-lg md:text-xl text-gray-300 mt-2 drop-shadow-lg max-w-2xl mx-auto">
                    Специализируюсь на создании высоконагруженных приложений на Laravel, Vue.js и Docker.
                </p>
            ...
            <div class="flex flex-col gap-4 w-full max-w-md animate-slideUp">
                ...
                >
                    ...
                    <div class="relative flex items-center justify-center gap-3">
                        ...
                        <span class="text-2xl font-semibold text-white tracking-wide">Мои проекты</span>
                ...
                >
                    ...
                    <div class="relative flex items-center justify-center gap-3">
                        ...
                        <span class="text-2xl font-semibold text-white tracking-wide">Связаться со мной</span>
                    ...
                    <p class="relative text-sm text-white/60 mt-2 group-hover:text-white/80 transition-colors">
                        Напишите мне для сотрудничества
                    </p>
                </Link>

                <!-- Кнопка "Управление сайтом / Вход в админку" (оставлена!) -->
                <Link
                ...
                >
                    ...
                    <div class="relative flex items-center justify-center gap-3">
                        ...
                        <span class="text-2xl font-semibold text-white tracking-wide">
                            {{ isAuthenticated ? `Админ-панель (${userName})` : 'Войти в админ-панель' }}
                        </span>
                        <svg :class="`w-6 h-6 text-white/90 transform group-hover:translate-x-2 transition-transform ${theme.text}`"
                             fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    ...
                    <p class="relative text-sm text-white/60 mt-2 group-hover:text-white/80 transition-colors">
                        {{ isAuthenticated ? 'Управляйте товарами и заказами' : 'Войдите, чтобы управлять сайтом' }}
                    </p>
                </Link>
            </div>
        </div>
